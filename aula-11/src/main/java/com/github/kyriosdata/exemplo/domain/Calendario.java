 ...
 *
 * <p>
 * Implementação do algoritmo criado por LARSEN, K. S. Computing the Day of the
 * week, Dr. Dobb´s Journal, april, 1995.
 */
public final class Calendario {
    ...
    /**
     * Nomes dos dias da semana, iniciado por "segunda-feira" (índice 0), seguido de
     * terça-feira (índice 1) e assim sucessivamente, até "domingo" (índice 6).
     */
    public static String[] semana = { "segunda-feira", "terça-feira", "quarta-feira", "quinta-feira", "sexta-feira",
            "sábado", "domingo" };
     ...
     * @return O dia da semana correspondente à data. O valor 0 para segunda-feira,
     *         1 para terça-feira, 2 para quarta-feira e assim sucessivamente.
     * @throws IllegalArgumentException Se o dia for inválido (menor que um ou maior
     *                                  que 31), o mês for inválido (menor que 1 ou
     *                                  maior que 12) ou o ano for menor que 1753.
     */
    ...
    /**
     * Produz sequência de caracteres indicando o dia corrente e o dia da semana
     * correspondente.
     *
     * @return Sequência que indica o dia corrente (dia em que o método é executado)
